...
namespace FontParser.Tables.BitmapAndSvgFonts
{
    ...
    internal class CBDT : TableEntry, IDisposable
    {
        public const string _N = "CBDT";
        public override string Name => _N;

        private readonly GlyphBitmapDataFmt17 _format17 = new GlyphBitmapDataFmt17();
        private readonly GlyphBitmapDataFmt18 _format18 = new GlyphBitmapDataFmt18();
        private readonly GlyphBitmapDataFmt19 _format19 = new GlyphBitmapDataFmt19();

        private MemoryStream _ms; //sub-stream contains image data
        private ByteOrderSwappingBinaryReader _binReader;
        ...
        protected override void ReadContentFrom(BinaryReader reader)
        {
            ...
            //-------------------
            byte[] data = reader.ReadBytes((int)Header.Length);//***
