...
namespace FontParser.Tables.BitmapAndSvgFonts
{
    internal class SvgTable : TableEntry
    {
        ...
        private Dictionary<ushort, int> _dicSvgEntries;
        private SvgDocumentEntry[] _entries; //TODO: review again
        ...
        private static void dbugSaveAsHtml(string filename, string originalGlyphSvg)
        {
