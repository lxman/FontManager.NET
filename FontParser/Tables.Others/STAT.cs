...
namespace FontParser.Tables.Others
{
    ...
    /// </summary>
    internal class STAT : TableEntry
    {
        ...
        protected override void ReadContentFrom(BinaryReader reader)
        {
            ...
            ushort[] axisValueOffsets = reader.ReadUInt16Array(axisValueCount); // Array of offsets to axis value tables,in bytes from the start of the axis value offsets array.
