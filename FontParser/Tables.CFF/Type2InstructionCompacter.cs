...
namespace FontParser.Tables.CFF
{
    internal class Type2InstructionCompacter
    {
...
#endif
        private List<Type2Instruction> _step1List;
        private List<Type2Instruction> _step2List;
        ...
        private static byte IsLoadIntOrMergeableLoadIntExtension(OperatorName opName)
        {
            switch (opName)
            {
