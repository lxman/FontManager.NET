...
namespace FontParser.Tables.Variations
{
    ...
    /// </summary>
    internal class MVar : TableEntry
    {
        ...
        private class ValueTagInfo
        {
            ...
            public ValueTagInfo(string tag, string mnemonic, string valueRepresented)
            {
                Tag = tag;
                Mnemonic = mnemonic;
                ValueRepresented = valueRepresented;
            }
        ...
        private static class ValueTags
        {
            private static Dictionary<string, ValueTagInfo> s_registerTags = new Dictionary<string, ValueTagInfo>();
            ...
            private static void RegisterValueTagInfo(string tag, string mnemonic, string valueRepresented)
            {
