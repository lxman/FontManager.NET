...
namespace FontParser.Tables.AdvancedLayout
{
    ...
    public abstract class GlyphShapingTableEntry : TableEntry
    {
        ...
        public FeatureList.FeatureList FeatureList { get; private set; }
        ...
        protected override void ReadContentFrom(BinaryReader reader)
        {
            ...
            FeatureList = AdvancedLayout.FeatureList.FeatureList.CreateFrom(reader, tableStartAt + featureListOffset);
        ...
        private void ReadLookupListTable(BinaryReader reader, long lookupListBeginAt)
        {
            ...
            ushort[] lookupTableOffsets = reader.ReadUInt16Array(lookupCount);
