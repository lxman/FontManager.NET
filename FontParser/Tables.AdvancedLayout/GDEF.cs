...
namespace FontParser.Tables.AdvancedLayout
{
    internal class GDEF : TableEntry
    {
        ...
        protected override void ReadContentFrom(BinaryReader reader)
        {
            ...
            GlyphClassDef = (glyphClassDefOffset == 0) ? null : ClassDefTable.ClassDefTable.CreateFrom(reader, _tableStartAt + glyphClassDefOffset);
            AttachmentListTable = (attachListOffset == 0) ? null : AttachmentListTable.CreateFrom(reader, _tableStartAt + attachListOffset);
            LigCaretList = (ligCaretListOffset == 0) ? null : LigCaretList.CreateFrom(reader, _tableStartAt + ligCaretListOffset);
            ...
            if (markAttachClassDefOffset == 2)
            {
                ...
                MarkAttachmentClassDef = (markAttachClassDefOffset == 0) ? null : ClassDefTable.ClassDefTable.CreateFrom(reader, reader.BaseStream.Position);
            }
            else
            {
                MarkAttachmentClassDef = (markAttachClassDefOffset == 0) ? null : ClassDefTable.ClassDefTable.CreateFrom(reader, _tableStartAt + markAttachClassDefOffset);
            }
#else
            ...
            MarkGlyphSetsTable = (markGlyphSetsDefOffset == 0) ? null : MarkGlyphSetsTable.CreateFrom(reader, _tableStartAt + markGlyphSetsDefOffset);
        ...
        public ClassDefTable.ClassDefTable GlyphClassDef { get; private set; }
        public AttachmentListTable AttachmentListTable { get; private set; }
        public LigCaretList LigCaretList { get; private set; }
        public ClassDefTable.ClassDefTable MarkAttachmentClassDef { get; private set; }
        ...
        {
            //1. glyph def
            ClassDefTable.ClassDefTable classDef = GlyphClassDef;
        ...
        {
            AttachmentListTable attachmentListTable = AttachmentListTable;
        ...
        private void FillMarkAttachmentClassDefs(Glyph[] inputGlyphs)
        {
            ...
            ClassDefTable.ClassDefTable markAttachmentClassDef = MarkAttachmentClassDef;
        ...
        private void FillMarkGlyphSets(Glyph[] inputGlyphs)
        {
            ...
            //see the description of lookup flags in the “Lookup Table” section of the chapter, OpenType Layout Common Table Formats.
            MarkGlyphSetsTable markGlyphSets = MarkGlyphSetsTable;
