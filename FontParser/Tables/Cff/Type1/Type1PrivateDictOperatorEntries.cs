...
{
    public class Type1PrivateDictOperatorEntries : ReadOnlyDictionary<ushort, CffDictEntry?>
    {
        public Type1PrivateDictOperatorEntries(IDictionary<ushort, CffDictEntry?> dictionary) : base(dictionary)
        {
            ...
            dictionary.Add(0x0C09, new CffDictEntry("BlueScale", OperandKind.Number, 0));
            dictionary.Add(0x0C0A, new CffDictEntry("BlueShift", OperandKind.Number, 0));
            dictionary.Add(0x0C0B, new CffDictEntry("BlueFuzz", OperandKind.Number, 0));
            ...
            dictionary.Add(0x0C12, new CffDictEntry("ExpansionFactor", OperandKind.Number, 0));
