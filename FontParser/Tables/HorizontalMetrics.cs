...
namespace FontParser.Tables
{
    ...
    internal class HorizontalMetrics : TableEntry
    {
        ...
        private readonly ushort[] _advanceWidths; //in font design unit
        private readonly short[] _leftSideBearings;//lsb, in font design unit
        private readonly int _numOfHMetrics;
