...
namespace NewFontParser.Tables.Proprietary.Panose
{
    public class PanoseInterpreter
    {
        ...
        {
            [0] = "Any", [1] = "No Fit", [2] = "Latin Text", [3] = "Latin Hand Written", [4] = "Latin Decorative",
            [5] = "Latin Symbol"
        };
        ...
        {
            [0] = "Any", [1] = "No Fit", [2] = "Cove", [3] = "Obtuse Cove", [4] = "Square Cove", [5] = "Obtuse Square Cove",
            [6] = "Square", [7] = "Thin", [8] = "Oval", [9] = "Exaggerated", [10] = "Triangle", [11] = "Normal Sans",
            [12] = "Obtuse Sans", [13] = "Perpendicular Sans", [14] = "Flared", [15] = "Rounded"
        };

        private static readonly Dictionary<int, string> WeightValues = new Dictionary<int, string>
        {
            [0] = "Any", [1] = "No Fit", [2] = "Very Light", [3] = "Light", [4] = "Thin", [5] = "Book", [6] = "Medium", [7] = "Demi",
            [8] = "Bold", [9] = "Heavy", [10] = "Black", [11] = "Extra Black (Nord)"
        };
        ...
        {
            [0] = "Any", [1] = "No Fit", [2] = "Flat Nib", [3] = "Pressure Point", [4] = "Engraved", [5] = "Ball (Round Cap)",
            [6] = "Brush", [7] = "Rough", [8] = "Felt Pen/Brush Tip", [9] = "Wild Brush - Drips a lot"
        };

        private static readonly Dictionary<int, string> SpacingValues = new Dictionary<int, string>
        {
            [0] = "Any", [1] = "No Fit", [2] = "Proportional Spaced", [3] = "Monospaced"
        };

        private static readonly Dictionary<int, string> AspectRatioValues = new Dictionary<int, string>
        {
            [0] = "Any", [1] = "No Fit", [2] = "Very Condensed", [3] = "Condensed", [4] = "Normal", [5] = "Expanded",
            [6] = "Very Expanded"
        };

        private static readonly Dictionary<int, string> ContrastValues = new Dictionary<int, string>
        {
            [0] = "Any", [1] = "No Fit", [2] = "None", [3] = "Very Low", [4] = "Low", [5] = "Medium Low",
            [6] = "Medium", [7] = "Medium High", [8] = "High", [9] = "Very High", [10] = "Horizontal Low",
            [11] = "Horizontal Medium", [12] = "Horizontal High", [13] = "Broken"
        };

        private static readonly Dictionary<int, string> TopologyValues = new Dictionary<int, string>
        {
            [0] = "Any", [1] = "No Fit", [2] = "Roman Disconnected", [3] = "Roman Trailing", [4] = "Roman Connected",
            [5] = "Cursive Disconnected", [6] = "Cursive Trailing", [7] = "Cursive Connected", [8] = "Blackletter Disconnected",
            [9] = "Blackletter Trailing", [10] = "Blackletter Connected"
        };

        private static readonly Dictionary<int, string> FormValues = new Dictionary<int, string>
        {
            [0] = "Any", [1] = "No Fit", [2] = "Upright / No Wrapping", [3] = "Upright / Some Wrapping",
            [4] = "Upright / More Wrapping", [5] = "Upright / Extreme Wrapping", [6] = "Oblique / No Wrapping",
            [7] = "Oblique / Some Wrapping", [8] = "Oblique / More Wrapping", [9] = "Oblique / Extreme Wrapping",
            [10] = "Exaggerated / No Wrapping", [11] = "Exaggerated / Some Wrapping", [12] = "Exaggerated / More Wrapping",
            [13] = "Exaggerated / Extreme Wrapping"
        };

        private static readonly Dictionary<int, string> FinialsValues = new Dictionary<int, string>
        {
            [0] = "Any", [1] = "No Fit", [2] = "None / No loops", [3] = "None / Closed loops", [4] = "None / Open loops",
            [5] = "Sharp / No Loops", [6] = "Sharp / Closed Loops", [7] = "Sharp / Open Loops", [8] = "Tapered / No Loops",
            [9] = "Tapered / Closed Loops", [10] = "Tapered / Open Loops", [11] = "Round / No Loops",
        ...
        {
            [0] = "Any", [1] = "No Fit", [2] = "Derivative", [3] = "Non-standard Topology", [4] = "Non-standard Elements",
            [5] = "Non-standard Aspect", [6] = "Initials", [7] = "Cartoon", [8] = "Picture Stems", [9] = "Ornamented",
            [10] = "Text and Background", [11] = "Collage", [12] = "Montage"
        };

        private static readonly Dictionary<int, string> AspectValues = new Dictionary<int, string>
        {
            [0] = "Any", [1] = "No Fit", [2] = "Super Condensed", [3] = "Very Condensed", [4] = "Condensed",
            [5] = "Normal", [6] = "Extended", [7] = "Very Extended", [8] = "Super Extended",
            [9] = "Monospaced"
        };
        ...
        private static readonly Dictionary<int, string> SerifVariantValues = new Dictionary<int, string>
        {
            [0] = "Any", [1] = "No Fit", [2] = "Cove", [3] = "Obtuse Cove", [4] = "Square Cove", [5] = "Obtuse Square Cove",
            [6] = "Square", [7] = "Thin", [8] = "Oval", [9] = "Exaggerated", [10] = "Triangle", [11] = "Normal Sans",
            [12] = "Obtuse Sans", [13] = "Perpendicular Sans", [14] = "Flared", [15] = "Rounded", [16] = "Script"
        };

        private static readonly Dictionary<int, string> TreatmentValues = new Dictionary<int, string>
        {
            [0] = "Any", [1] = "No Fit", [2] = "None - Standard Solid Fill", [3] = "White / No Fill", [4] = "Patterned Fill",
            [5] = "Complex Fill", [6] = "Shaped Fill", [7] = "Drawn / Distressed"
        };

        private static readonly Dictionary<int, string> LiningValues = new Dictionary<int, string>
        {
            [0] = "Any", [1] = "No Fit", [2] = "None", [3] = "Inline", [4] = "Outline", [5] = "Engraved (Multiple Lines)",
            [6] = "Shadow", [7] = "Relief", [8] = "Backdrop"
        };

        private static readonly Dictionary<int, string> TopologyLdValues = new Dictionary<int, string>
        {
            [0] = "Any", [1] = "No Fit", [2] = "Standard", [3] = "Square", [4] = "Multiple Segment",
            [5] = "Deco (E.M.S.) Waco midlines", [6] = "Uneven Weighting", [7] = "Diverse Arms", [8] = "Diverse Forms",
            [9] = "Lombardic Forms", [10] = "Upper Case in Lower Case", [11] = "Implied Topology",
        ...
        {
            [0] = "Any", [1] = "No Fit", [2] = "Montages", [3] = "Pictures", [4] = "Shapes", [5] = "Scientific",
            [6] = "Music", [7] = "Expert", [8] = "Patterns", [9] = "Boarders", [10] = "Icons", [11] = "Logos",
            [12] = "Industry specific"
        };

        private static readonly Dictionary<int, string> AspectCharXxValues = new Dictionary<int, string>
        {
            [0] = "Any", [1] = "No Fit", [2] = "No Width", [3] = "Exceptionally Wide", [4] = "Super Wide",
