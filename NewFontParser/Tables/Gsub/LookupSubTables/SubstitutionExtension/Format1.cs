...
namespace NewFontParser.Tables.Gsub.LookupSubTables.SubstitutionExtension
{
    public class Format1 : ILookupSubTable
    {
        ...
        public Format1(BigEndianReader reader)
        {
            ...
            {
                1 => new SingleSubstitution.Format1(reader),
                2 => new MultipleSubstitution.Format1(reader),
                3 => new AlternateSubstitution.Format1(reader),
                4 => new LigatureSubstitution.Format1(reader),
